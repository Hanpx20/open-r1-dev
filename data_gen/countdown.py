...
<think>"""
    ...
    if template_type == 'no':
        prefix = f"Using the numbers {numbers}, create an equation that equals {target}. You can use basic arithmetic operations (+, -, *, /) and each number can only be used once."
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--template_type', type=str, default='no')
    ...
    test_dataset = test_dataset.map(function=make_map_fn(), with_indices=True, remove_columns=test_dataset.column_names)
