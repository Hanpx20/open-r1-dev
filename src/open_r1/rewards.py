...
def countdown_reward(solution_str, target, numbers, **kwargs):
    ...
    equation = extract_solution(solution_str, "answer")
    # Validate equation uses correct numbers
    if validate_equation(equation, numbers) and calc_equation(equation) != None and abs(target - calc_equation(equation)) < 1e-6:
        return 1.0
    else:     
        return 0.0
